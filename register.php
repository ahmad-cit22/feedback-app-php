...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!Input::isPasswordValid($password)) {
        $errorBag->addError('password', 'Please enter a password using al least one capital letter, one lowercase letter, one number and minimum 8 characters.');
    }
                        ...
                        <div class="mt-10 mx-auto w-full max-w-xl">
                            <form class="space-y-6" action="<?= $_SERVER['PHP_SELF'] ?>" method="POST" novalidate>
                                <div>
                                    ...
                                    <div class="mt-2">
                                        <input id="name" name="name" type="text" value="<?= $_POST['name'] ?? '' ?>" required class="block w-full rounded-md border-0 py-1.5 px-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div class="mt-2">
                                        <input id="email" name="email" type="email" value="<?= $_POST['email'] ?? '' ?>" autocomplete="email" required class="block w-full rounded-md border-0 py-1.5 px-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div class="mt-2">
                                        <input id="confirm_password" name="confirm_password" type="password" required class="block w-full rounded-md border-0 py-1.5 px-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                    </div>
